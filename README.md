...
| <a name="input_agent_image_pull_secrets"></a> [agent\_image\_pull\_secrets](#input\_agent\_image\_pull\_secrets) | List of names of imagePullSecrets to use for pulling the agent image. These secrets take precedence over global pull secrets. | `list(string)` | `[]` | no |
...
| <a name="input_cluster_shield_image_pull_secrets"></a> [cluster\_shield\_image\_pull\_secrets](#input\_cluster\_shield\_image\_pull\_secrets) | List of names of imagePullSecrets to use for pulling the cluster shield image. These secrets take precedence over global pull secrets. | `list(string)` | `[]` | no |
