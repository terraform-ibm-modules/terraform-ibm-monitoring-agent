...
| <a name="input_chart_version"></a> [chart\_version](#input\_chart\_version) | The version of the Cloud Monitoring agent helm chart to deploy. | `string` | `"1.83.0"` | no |
...
| <a name="input_cpu"></a> [cpu](#input\_cpu) | CPU required for the Cloud Monitoring agent. | `string` | `"500m"` | no |
...
| <a name="input_max_memory"></a> [max\_memory](#input\_max\_memory) | Maximum memory required for the Cloud Monitoring agent. | `string` | `"1Gi"` | no |
...
| <a name="input_min_memory"></a> [min\_memory](#input\_min\_memory) | Minimum memory required for the Cloud Monitoring agent. | `string` | `"256Mi"` | no |
