...
|------|-------------|------|---------|:--------:|
| <a name="input_chart_location"></a> [chart\_location](#input\_chart\_location) | The location of the Helm chart for the Sysdig agent. | `string` | `"https://charts.sysdig.com/charts/sysdig-deploy"` | no |
