...
func TestPrometheus(t *testing.T) {
	...
	options.TerraformVars = []testschematic.TestSchematicTerraformVar{
		{Name: "ibmcloud_api_key", Value: options.RequiredEnvironmentVars["TF_VAR_ibmcloud_api_key"], DataType: "string", Secure: true},
		{Name: "instance_region", Value: "us-south", DataType: "string"},
		{Name: "cluster_id", Value: "d23qddlw0qh9vu8kqtt0", DataType: "string"},
		{Name: "cluster_resource_group_id", Value: "91d5bb53f8e547caaf6308356bf84ecd", DataType: "string"},
		{Name: "access_key", Value: "228eb8d6-1754-4e1e-8b26-46cb6c184b9a", DataType: "string", Secure: true},
		{Name: "prometheus", Value: prometheus, DataType: "object{}", Secure: true},
	}
