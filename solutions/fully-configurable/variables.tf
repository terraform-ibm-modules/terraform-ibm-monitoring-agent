...
variable "chart_version" {
  ...
  default  = "1.112.0" # registryUrl: charts.sysdig.com
  nullable = false
}
...
variable "agent_image_tag_digest" {
  ...
  default  = "14.6.0@sha256:83d8a9c31de8737413ede5c262eb4e90bed8122aa3806868bb96d4544e925450" # datasource: icr.io/ext/sysdig/agent-slim
  nullable = false
}
...
variable "kernel_module_image_digest" {
  ...
  type        = string
  # This version is automatically managed by renovate automation - do not remove the datasource comment on next line
  default  = "14.6.0@sha256:3977076d3232510cd563175e32ef76ce4f02f2ecf797a9696ccfc64f58fea076" # datasource: icr.io/ext/sysdig/agent-kmodule
  nullable = false
  validation {
...
variable "cluster_shield_image_tag_digest" {
  ...
  type        = string
  # This version is automatically managed by renovate automation - do not remove the datasource comment on next line
  default = "1.23.0@sha256:36a93fcb9c9056a600275c6d8d2aa2c0488d7a2381b0cee49665509856eae6fb" # datasource: icr.io/ext/sysdig/cluster-shield
}
