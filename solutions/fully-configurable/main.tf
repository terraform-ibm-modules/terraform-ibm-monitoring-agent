...
module "monitoring_agent" {
  ...
  global_image_pull_secrets         = var.global_image_pull_secrets
  agent_image_pull_secrets          = var.agent_image_pull_secrets
  cluster_shield_image_pull_secrets = var.cluster_shield_image_pull_secrets
